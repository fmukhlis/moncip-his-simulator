...
import { flexRender, getCoreRowModel, getPaginationRowModel, Table, useReactTable } from "@tanstack/react-table"
...
type TableOptions<TData> = Omit<Parameters<typeof useReactTable<TData>>[0], "getCoreRowModel" | "getPaginationRowModel">

type ClientTableProps<TData> = {
    ...
    <>
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <p className="text-muted-foreground text-center sm:text-start">
          Showing {start}-{end} of {totalCount} lab orders
        </p>
        <div className="flex flex-col items-center gap-2 sm:flex-row">
